...
async function refreshNow(){
 try{
  ...
  document.getElementById('bat').textContent=fmt(d.batteryVolts,' V',2);
  document.getElementById('bt').textContent=d.batteryTempValid?fmt(d.batteryTempC,' °C',1):'INVALID';
  document.getElementById('nt').textContent=d.nanoTempValid?fmt(d.nanoTempC,' °C',1):'INVALID';
